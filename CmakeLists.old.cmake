...
set(TEENSY_CORE ${ENV_CORE})
set(TEENSY_CORE_NAME ${ENV_CORE_NAME} CACHE INTERNAL "")
set(TEENSY_CPU ${ENV_CPU})
...
add_compile_definitions(${USB_SETTING} LAYOUT_US_ENGLISH __${TEENSY_CORE_NAME}__)
add_compile_definitions(_GNU_SOURCE TEENSYDUINO=156 F_CPU=${TEENSY_CORE_SPEED} USING_MAKEFILE)

add_compile_options(-Wall -g -mthumb -ffunction-sections -fdata-sections -nostdlib -MMD -O3) # -E
...
string(APPEND CMAKE_CXX_FLAGS "-std=gnu++17 -felide-constructors -fno-rtti -fno-exceptions")
...
add_library(core ${C_ASM_BUILD_FILES} ${C_C_BUILD_FILES} ${C_CXX_BUILD_FILES})
target_include_directories(core PUBLIC ${CORE_PATH})

add_library(libraries INTERFACE)
target_sources(libraries INTERFACE ${L_ASM_BUILD_FILES} ${L_C_BUILD_FILES} ${L_CXX_BUILD_FILES})
target_link_libraries(libraries INTERFACE core)

set(SOURCES ${S_ASM_BUILD_FILES} ${S_C_BUILD_FILES} ${S_CXX_BUILD_FILES} CACHE INTERNAL "")
add_executable(${PROJECT_NAME} ${SOURCES})
target_include_directories(${PROJECT_NAME} PUBLIC ${CORE_INCLUDE} ${LIBRARY_INCLUDE})
